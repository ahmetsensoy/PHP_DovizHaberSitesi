            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="post.php" method="post">
                            <h3 class="text-center text-info">Giriş Formu</h3>
                            <div class="form-group">
                                <label for="username" class="text-info">Kullanıcı Adı:</label><br>
                                <input type="text" name="kAdi" id="kAdi" class="form-control" placeholder="admin">
                            </div>
                            <div class="form-group">
                                <label for="password" class="text-info">Şifre:</label><br>
                                <input type="text" name="sifre" id="sifre" class="form-control" placeholder="123">
                            </div>
                            <div class="form-group">
